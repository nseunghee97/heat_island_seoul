...
setwd("D:/workspace/ds_yonsei/project/PPT (2)")
```
...
#### 2) **풍속/풍향** : 지상 10m, 80m에서 연 평균 풍속/풍향 
#### 3) **토지피복** : 상업 업무지, 도로, 일반주택지, 인공녹지, 하천 등
#### 4) **고도** : 해발고도
...
### 1) 열섬현상(온도)과 미세먼지의 지리적 분포 파악

### 2) 상관관계 분석을 통해 열섬현상과 미세먼지에 영향을 미치는 변수 파악
