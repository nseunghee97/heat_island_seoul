...
## 팔레트
index_bins <- c(0, 0.9, 2)
index_pal  <- colorBin("YlOrBr", domain = heat_sf$index, bins = index_bins)

## 라벨
index_labels <- sprintf(
  "<strong>cluster : %s</strong><br/> index : %g <br/> average temperature : %g\u00B0C",
  heat_sf$label, heat_sf$index, heat_sf$avg_tmp 
