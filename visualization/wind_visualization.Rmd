...
## 팔레트
wind_bins <- c(2.2, 2.5, 2.7, 3.0, 3.5, 4, 4.5)
wind_pal  <- colorBin("Blues", domain = heat_sf$X10m_wind_speed , bins = wind_bins)

## 라벨
wind_labels <- sprintf(
  "<strong>cluster : %s</strong><br/> 10m wind speed : %g m/s <br/>80m wind speed : %g m/s <br/> average temperature : %g\u00B0C",
  heat_sf$label, heat_sf$X10m_wind_speed, heat_sf$X80m_wind_speed, heat_sf$avg_tmp 
